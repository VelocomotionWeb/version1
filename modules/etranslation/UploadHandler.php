...
class UploadHandler 
{
    ...
    protected $error_messages = array(
    	...
    	'not_authenticated_user' => 'Not Allow for unauthenticated user, plaise login again or refresh page',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            // 'accept_file_types' => '/.+$/i',
        	//'accept_file_types' => '/\.(tiff|gif|jpe?g|png|xml|txt|html|json)$/i',
        	'accept_file_types' => '/^[^.]+$|\.(?!(js|exe|php)$)([^.]+$)/',
