<?php
class mpstorelocatorstorelocModuleFrontController extends ModuleFrontController
{
...
//echo $seller_stores[$key]['link_rewrite'];				
	...
	public function setMedia()
	{
       ...
       // $this->addJS(_MODULE_DIR_.'/themes/jms_travel/js/modules/blockcart/ajax-cart.js');
		...
		$this->addCSS(_MODULE_DIR_.'mpstorelocator/views/css/storeloc.css');
