...
class GAdwords extends Module
{
	...
	public function getContent()
	{
		...
		{
			case 'at':
				$landing_page = 'http://www.google.at/intl/de/adwords/start/';
				break;
			case 'be':
				$landing_page = 'http://www.google.com/intl/fr/ads/get/prestashop75/index.html';
				break;
			case 'bg':
				$landing_page = 'http://www.google.bg/intl/bg/adwords/start/';
				break;
			case 'cz':
				$landing_page = 'http://www.google.cz/intl/cz/adwords/start/';
				break;
			case 'dk':
				$landing_page = 'http://www.google.dk/intl/da/adwords/start/';
				break;
			case 'ee':
				$landing_page = 'http://www.google.ee/intl/et/adwords/start/';
				break;
			case 'fr':
				$landing_page = 'http://www.google.com/intl/fr/ads/get/prestashop75/index.html';
				break;
			case 'de':
				$landing_page = 'http://www.google.de/intl/de/adwords/start/';
				break;
			case 'gr':
				$landing_page = 'http://www.google.gr/intl/el/adwords/start/';
				break;
			case 'hu':
			...
			case 'it':
				...
				break;
			case 'lv':
				$landing_page = 'http://www.google.lv/intl/lv/adwords/start/';
				break;
			case 'lt':
				$landing_page = 'http://www.google.lt/intl/lt/adwords/start/';
				break;
			case 'nl':
			...
			case 'pl':
				...
				break;
			case 'pt':
				$landing_page = 'http://www.google.com/intl/pt-PT/ads/get/prestashop60/index.html';
				break;
			case 'ro':
				$landing_page = 'http://www.google.ro/intl/roz/adwords/start/';
				break;
			case 'sk':
				$landing_page = 'http://www.google.sk/intl/sk/adwords/start/';
				break;
			case 'es':
				$landing_page = 'http://www.google.com/intl/es/ads/get/prestashop75/index.html';
				break;
			case 'se':
				$landing_page = 'http://www.google.se/intl/sv/adwords/start/';
				break;
			case 'ch':
				$landing_page = 'http://www.google.ch/intl/de/adwords/start/';
				break;
			case 'tr':
				$landing_page = 'http://www.google.com.tr/intl/tr/adwords/start/';
				break;
			case 'gb':
			case 'en':
				$landing_page = 'http://www.google.co.uk/ads/get/prestashop75/index.html';
