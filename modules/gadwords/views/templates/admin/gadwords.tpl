		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="col-xs-12 text-center">
						...
						<a href="{$landing_page|escape:htmlall}" target="_blank" class="btn btn-primary" id="create-account-btn">{l s='Start your campaign now with your promotional code' mod='gadwords'}</a><br><br>
				</div>
				<em class="small">
