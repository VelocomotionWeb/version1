...

	{
		...
		foreach ($_blocks as $key => $_block) 
		{
			...
			else if	($_block['block_type'] == 'logo') 
			{
				...
				$_blocks[$key]['return_value'] .= '<img class="logo" src="/img/logo_tel.png" alt="'.Configuration::get('PS_SHOP_NAME').'" />';
				/*
				if ($id_lang==1) 	$_blocks[$key]['return_value'] .= '<div class="aff_tel">Tél : 09 53 60 44 41</div>';
				else 				$_blocks[$key]['return_value'] .= '<div class="aff_tel">Phone : 09 53 60 44 41</div>';
				*/
