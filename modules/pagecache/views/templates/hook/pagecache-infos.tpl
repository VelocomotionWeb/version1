...
<table id="pagecache_stats">
	<caption>
		<img
			style="float: left; display: inline; width: 24px; height: 24px; margin-right: 5px" src="{$base_dir|escape:'html':'UTF-8'}/modules/pagecache/logo.png" 
			alt="" width="24" height="24"/>
		{l s='PAGE CACHE - INFOS' mod='pagecache'}
		<div class="actions">
			<a href="{$url_on_off|escape:'htmlall':'UTF-8'}" class="pagecache" title="{if $dbgpagecache eq '1'}{l s='Click to disable cache' mod='pagecache'}{else}{l s='Click to enable cache' mod='pagecache'}{/if}"><img src="{$base_dir|escape:'html':'UTF-8'}/modules/pagecache/views/img/{if $dbgpagecache eq '1'}on{else}off{/if}.png" alt="" width="32" height="32/"></a> 
			<a href="{$url_reload|escape:'htmlall':'UTF-8'}" class="pagecache" title="{l s='Reload this page, use browser cache if any' mod='pagecache'}"><img src="{$base_dir|escape:'html':'UTF-8'}/modules/pagecache/views/img/reload.png" alt="" width="32" height="32/"></a>
			<a href="{$url_del|escape:'htmlall':'UTF-8'}" class="pagecache" title="{l s='Force this page to be generated (refresh cache)' mod='pagecache'}"><img src="{$base_dir|escape:'html':'UTF-8'}/modules/pagecache/views/img/trash.png" alt="" width="32" height="32/"></a>
			<a href="#" class="pagecache" title="{l s='Display more technical informations' mod='pagecache'}" onclick="$('.adv').show();$('#pagecache_stats').css('width', 'inherit');return false;"><img src="{$base_dir|escape:'html':'UTF-8'}/modules/pagecache/views/img/plus.png" alt="" width="32" height="32/"></a>
			<a href="{$url_close|escape:'htmlall':'UTF-8'}" class="pagecache" title="{l s='Close this infos box' mod='pagecache'}"><img src="{$base_dir|escape:'html':'UTF-8'}/modules/pagecache/views/img/close.png" alt="" width="32" height="32/"></a>
		</div>
	</caption>
	<tbody>
		<tr>
