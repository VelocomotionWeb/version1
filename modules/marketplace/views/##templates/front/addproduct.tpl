						...
						<div class="tab-pane active" id="information">
							...
							<div class="form-group">	
								<label for="product_description" class="control-label">{l s='Description :' mod='marketplace'}</label>
							  	<textarea class="wk_tinymce form-control" id="product_description" name="product_description">{if isset($smarty.post.product_description)}{$smarty.post.product_description|escape:'html':'UTF-8'}{/if}</textarea>
							</div>
...
*}
							...
							<div class="form-group">
								...
								<div class="input-group">
							  		<input type="text" id="product_price" name="product_price" value="{if isset($smarty.post.product_price)}{$smarty.post.product_price|escape:'html':'UTF-8'}{/if}"  class="account_input form-control"/>
