								...
								<div class="wk_collecion_details">
                                    {if !$PS_CATALOG_MODE} <!-- if catalog mode is disabled by config (by default)-->
                                        {if $product.show_price}
                                            ...
                                            {convertPrice price=$product.product->getPrice(true, 0, 7, null, false, true, $quantite)*$quantite}
                                            </div>
                                        {/if}
                                        ...
                                        {else} 
                                            <div id="img_{$product.id_product}" class="float_right img">
                                                ...
                                                href1="{$link->getPageLink('cart',false, NULL, "add=1&amp;id_product={$product.id_product|intval}&amp;qty=-1&amp;token={$token}", false)|escape:'html':'UTF-8'}" rel="nofollow" title="{l s='Add to cart' mod='marketplace'}" 
