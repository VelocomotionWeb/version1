        ...
        <input type="hidden" name="lat" value="{$store.latitude}">
                    ...
                    <div class="wk_store {if $store.link_rewrite==$shop_link_rewrite_ec}active{/if} see_prod" id="{$store.id|escape:'htmlall':'UTF-8'}" store_name="{$store.name}" addr="{$store.map_address|escape:'htmlall':'UTF-8'}" lat="{$store.latitude|escape:'htmlall':'UTF-8'}" lng="{$store.longitude|escape:'htmlall':'UTF-8'}" link="{$store.link_rewrite}" store_postal="{$store.zip_code}" counter="{counter}">
                        ...
                        <div class="wk_store_img">
                            ...
                            <img src="{$modules_dir|escape:'html':'UTF-8'}mpstorelocator/views/img/store_logo/logo.png"/>
            ...
            {if $trouve}
                ...
                <input type="hidden1" name="quantity_wanted" id="quantity_wanted" value="{$quantite}">
            {/if}
                                        ...
                                        {if !$PS_CATALOG_MODE} <!-- if catalog mode is disabled by config (by default)-->
                                            ...
                                            <ul>
                                                ...
                                                {if $product.show_price}
                                                    ...
                                                    <li id="price_{$product.id_product}" class="price">
                                                ...
                                                <li id="qty_{$product.id_product}" class="qty"><i class="fa fa-calendar" aria-hidden="true"></i> {$quantite} {l s='day' mod='marketplace'}{if $quantite>1}s{/if}</li>

                                                <div class="clear"></div>

                                                <li id="quantity_{$product.id_product}" class="quantity">
                                            ...
                                            {if $product.product_in_cart==0}
                                                ...
                                                <a class="button ajax_add_to_cart_button btn btn-block btn_loc"
