...
{if $is_seller == 1}
	...
	<li>
		<a title="{l s='Edit Profile' mod='marketplace'}" href="{if isset($edit_profile_link)}{$edit_profile_link|escape:'html':'UTF-8'}{else}{$link->getModuleLink('marketplace', 'editprofile')|escape:'html':'UTF-8'}{/if}">
