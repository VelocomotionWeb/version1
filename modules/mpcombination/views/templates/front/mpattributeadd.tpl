{capture name=path}
	...
	<span class="navigation_page">{l s='Create Combination' mod='mpcombination'}</span>
{/capture}
{if $logged}
	...
	<div class="main_block">
		...
		<div class="dashboard_content">
			...
			<div class="wk_right_col">
				<a href="{$link->getModuleLink('marketplace', 'productupdate', ['flag' => 1, 'id' => $mp_product_id|escape:'htmlall':'UTF-8','editproduct' => 1])|escape:'htmlall':'UTF-8'}" class="btn btn-default button button-small pull-right">
					<span>{l s='Back to product' mod='mpcombination'}</span>
				</a>
				<div class="form-group form-horizontal">
					<form action="{$link->getModuleLink('mpcombination', 'mpattributemanage', ['mp_product_id' => $mp_product_id|escape:'htmlall':'UTF-8'])|escape:'htmlall':'UTF-8'}" method="post" id="mp_attribute_add_pro" class=" defaultForm ">
						<div class="full left">
							<input type="hidden" value="" id="mp_id_product_attribute" name="mp_id_product_attribute"/>
							<div class="full left form-group">
								...
								<div class="col-lg-9">
									<span style="float:left;margin-right:5px;">
										...
										<input type="hidden" id="mp_id_product" name="mp_id_product" value="{$mp_product_id|escape:'htmlall':'UTF-8'}"/>
										
										<select class="form-control" id="attribute_select"  style="width: 140px;" name="attribute_select">
										...
										<div class="form-group">
											<span style="float:left;margin-right:5px;">
												...
												{foreach $attribute_box as $attribute_box1}
													<option  value="{$attribute_box1['id']|escape:'htmlall':'UTF-8'}" groupid="{$attribute_box1['groupid']|escape:'htmlall':'UTF-8'}">{$attribute_box1['name']|escape:'htmlall':'UTF-8'}</option>
												{/foreach}
												{/if}
												</select>
											</span>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input type="text" value="0" name="mp_quantity" id="mp_quantity" value="{if isset($smarty.post.mp_quantity)}{$smarty.post.mp_quantity|escape:'htmlall':'UTF-8'}{/if}" class="form-control"/>
								</div>
							</div>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input type="text" value="" placeholder="Reference" name="mp_reference" id="mp_reference" value="{if isset($smarty.post.mp_reference)}{$smarty.post.mp_reference|escape:'htmlall':'UTF-8'}{/if}" class="form-control"/>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input type="text" value="" placeholder="EAN13" name="mp_ean13" id="mp_ean13" value="{if isset($smarty.post.mp_ean13)}{$smarty.post.mp_ean13|escape:'htmlall':'UTF-8'}{/if}" class="form-control"/>
									<p class="preference_description">{l s='Special characters allowed ' mod='mpcombination'} .-_#</p>
								</div>
							</div>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input type="text" value="" placeholder="UPC" name="mp_upc" id="mp_upc" value="{if isset($smarty.post.mp_upc)}{$smarty.post.mp_upc|escape:'htmlall':'UTF-8'}{/if}" class="form-control"/>
									<p class="preference_description">{l s='Special characters allowed ' mod='mpcombination'} .-_#</p>
								</div>
							</div>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input type="text" value="0" name="mp_wholesale_price" id="mp_wholesale_price" value="{if isset($smarty.post.mp_wholesale_price)}{$smarty.post.mp_wholesale_price|escape:'htmlall':'UTF-8'}{/if}" class="form-control"/>
								</div>
							</div>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-9">
									<span style="float:left;margin-right:5px;">
										<select class="form-control" id="attribute_price_impact" onchange="check_impact(); calcImpactPriceTI();" style="width: 140px;" name="attribute_price_impact">
							...
							<div class="full left form-group">
								...
								<div class="col-lg-9">
									<span style="float:left;margin-right:5px;">
										<select class="form-control" id="attribute_weight_impact" onchange="check_weight_impact();" style="width: 140px;" name="attribute_weight_impact">
									...
									<span id="impact_weight_span" class="col-lg-3" {if $mp_weight==(float)0} style="display:none"{/if}>
										<input id="attribute_weight" type="text" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" value="0" name="attribute_weight" size="6" class="form-control"/>
									</span>
								</div>
							</div>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-9">
									<span style="float:left;margin-right:5px;">
										<select class="form-control" id="attribute_unit_impact" onchange="check_unit_impact();" style="width: 140px;" name="attribute_unit_impact">
											<option value="0">{l s='None' mod='mpcombination'}</option>
											<option value="1">{l s='Increase' mod='mpcombination'}</option>
											<option value="-1">{l s='Reduction' mod='mpcombination'}</option>
										</select>
									</span>
									<span id="impact_unit_price_span" class="col-lg-3" {if $mp_unit_price_impact == (float)0} style="display:none"{/if}>
										<input id="attribute_unity" type="text" class="form-control" onkeyup="if (isArrowKey(event)) return ;this.value = this.value.replace(/,/g, '.');" value="0" name="attribute_unity" size="6" />
									</span>
								</div>
							</div>
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input id="attribute_minimal_quantity" class="form-control" type="text" value="{if isset($edit)}{$mp_minimal_quantity|escape:'htmlall':'UTF-8'}{else}1{/if}" name="attribute_minimal_quantity" maxlength="6" size="3">
							...
							<div class="full left form-group">
								...
								<div class="col-lg-3">
									<input id="available_date_attribute" class="datepicker1 form-control" type="text" style="text-align: center;" value="0000-00-00" name="available_date_attribute">
									...
									{if isset($mp_pro_image) && $mp_pro_image}
										<ul id="id_image_attr" class="list-inline">
											{foreach from=$mp_pro_image key=k item=image}
												<li>
													<input type="checkbox" name="id_image_attr[]" value="{$image.id_image|escape:'htmlall':'UTF-8'}" id="id_image_attr_{$image.id_image|escape:'htmlall':'UTF-8'}" class="attri_images"/>
							...
							<div class="left full" style="text-align:center;">
								<button class="btn btn-default button button-medium" type="submit" id="btn_combination_validate" name="range_submit">
									<span>{l s='Add' mod='mpcombination'}</span>
								</button>
							</div>
						</div>
					</form>
...
{else}
	<div class="alert alert-danger">
		{l s='You are logged out. Please login to create combination.' mod='mpcombination'}</span>
	</div>
{/if}
{strip}
