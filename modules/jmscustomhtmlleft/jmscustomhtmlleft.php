...
class JmsCustomhtmlLeft extends Module
{
	...
	{
		$return = true;
		$html_demo = '<div class="banner-left"><img class="img-responsive" src="themes/jms_travel/img/left.jpg" alt="Left banner" />
<div class="banner-left-content"><span>Discount 30%</span>
<p>Opera House</p>
</div>
</div>';
		$info = new JmsHtmlLeft();
