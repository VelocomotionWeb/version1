...
{include file="$module_local_path/views/templates/admin/tab_header.tpl"}
    ...
    <ps-panel icon="icon-cogs" img="../img/t/AdminBackup.gif" header="{l s='Variable settings' mod='oparteasyseoforprestashop'}">
        <ps-input-text ps_id="oesfp_cms_title" name="oesfp_title" label="Meta title" help="{l s='You can use link below to add dynamique data' mod='oparteasyseoforprestashop'}"  value="{if isset($meta_data)}{$meta_data['meta_title']|escape:'htmlall':'UTF-8'}{/if}" required="true"></ps-input-text>
        <ps-form-group>
           <a href="#oesfp_cms_title" class="addTaglink">[META_TITLE]</a> &nbsp;  &nbsp; 
           <a href="#oesfp_cms_title" class="addTaglink">[CONTENT]</a> &nbsp;  &nbsp; 
           <a href="#oesfp_cms_title" class="addTaglink">[SHOP_NAME]</a>    
        </ps-form-group>
        <ps-input-text ps_id="oesfp_cms_desc" name="oesfp_desc" label="Meta description" help="{l s='You can use link below to add dynamique data' mod='oparteasyseoforprestashop'}" value="{if isset($meta_data)}{$meta_data['meta_desc']|escape:'htmlall':'UTF-8'}{/if}" required="true"></ps-input-text>
        <ps-form-group>
           <a href="#oesfp_cms_desc" class="addTaglink">[META_TITLE]</a> &nbsp;  &nbsp; 
           <a href="#oesfp_cms_desc" class="addTaglink">[CONTENT]</a> &nbsp;  &nbsp; 
           <a href="#oesfp_cms_desc" class="addTaglink">[SHOP_NAME]</a> &nbsp;  &nbsp;
        </ps-form-group>
        <ps-switch label="{l s='Override cms meta that are already filled ?' mod='oparteasyseoforprestashop'}" help="{l s='If you checked yes to this field, pages with meta data already filled will be overrited. Go back will not be possible.' mod='oparteasyseoforprestashop'}" name="oesfp_override" yes="yes" no="no" active="{if isset($meta_data.override_meta) && $meta_data.override_meta}true{else}false{/if}"></ps-switch>      
