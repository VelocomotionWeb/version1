...
{block name="field"}
	{if $input.type == 'product_search'}		
		<div class="input-group search-product-input">
			<input type="text" id="product" value="{$fields_value.product_name|escape:'html'}" />
			<input type="hidden" id="id_product" name="id_product" value="{$fields_value.id_product|escape:'html'}" />
			...
			<div id="result_products"></div>	
				...
				$(document).ready(function() {
					$( "#product" ).keyup(function() {		
						...
						$.ajax({
							type: 'GET',
							url: '{$base_url|escape:'html'}' + 'modules/jmsdeals/ajax_productsearch.php',
