...
const NO_RESULTS_TEMPLATE = '<li class="tp-ac__item no-results">Aucun r&eacute;sultat</li>';
const GEOLOCATE_TEMPLATE = '<li class="tp-ac__item geolocate">me g&eacute;olocaliser</li>';
...
class TeleportAutocomplete {
  ...
  getCities(cb) {
    ...
    const req = new XMLHttpRequest();
    req.open('GET', `${this.apiRoot}/cities/?search=${this.query+',france'}&embed=${embed}&limit=${this.maxItems}`);
    req.setRequestHeader('Accept', `application/vnd.teleport.v${this.apiVersion}+json`);
