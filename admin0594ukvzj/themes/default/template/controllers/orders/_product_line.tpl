...
<tr class="product-line-row">
	...
	<td class="total_product">3.
		{displayPrice price=(Tools::ps_round($product_price, 12) * ($product['product_quantity'] - $product['customizationQuantityTotal'])) currency=$currency->id}.2
	</td>
