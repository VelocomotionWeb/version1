...
*}
    ...
    {include file="$tpl_dir./../../modules/blocksearchhome/blocksearch-cms.tpl"}
...
{if isset($cms) && !isset($cms_category)}
	...
	{/if}
	<div class="rte{if $content_only} content_only{/if} block">
		{$cms->content}
	</div>
{elseif isset($cms_category)}
	<div class="block-cms">
		<h1 class="page-heading"><a href="{if $cms_category->id eq 1}{$base_dir}{else}{$link->getCMSCategoryLink($cms_category->id, $cms_category->link_rewrite)}{/if}">{$cms_category->name|escape:'htmlall':'UTF-8'}</a></h1>
