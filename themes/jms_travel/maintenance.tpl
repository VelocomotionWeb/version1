...
{/if}
	...
	<body>
		<div id="maintenance">
			<a href="{$base_dir}" id="header-logo" title="{$shop_name|escape:'html':'UTF-8'}"><img alt="{$shop_name|escape:'html':'UTF-8'}" src="{$content_dir}themes/jms_travel/img/logo.png"></a>
			<h3>{l s='Site Offline'}</h3>
			<p class="maintenance-img"><img src="{$content_dir}themes/jms_travel/img/maintenance.jpg" /></p>
			<p id="message">
