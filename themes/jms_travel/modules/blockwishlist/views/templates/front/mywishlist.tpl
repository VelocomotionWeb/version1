...
<div id="mywishlist">
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std form-inline" id="form_wishlist">			
				...
				<p class="text">
					...
					<input type="submit" name="submitWishlist" id="submitWishlist" value="{l s='Save' mod='blockwishlist'}" class="exclusive btn btn-default" />
				</p>				
		</form>
		{if $wishlists}
		<div id="block-history" class="block-center table_block table-responsive box">
				...
				{section name=i loop=$wishlists}
					<tr id="wishlist_{$wishlists[i].id_wishlist|intval}">
						...
						<td class="wishlist_delete">
							<a href="javascript:;"onclick="return (WishlistDelete('wishlist_{$wishlists[i].id_wishlist|intval}', '{$wishlists[i].id_wishlist|intval}', '{l s='Do you really want to delete this wishlist ?' mod='blockwishlist' js=1}'));"><span class="lnr lnr-cross"></span></a>
						</td>
					</tr>
				{/section}
				</tbody>
	...
	<ul class="footer_links">
		<li><a href="{$link->getPageLink('my-account', true)|escape:'html'}" class="btn btn-default">{l s='Back to Your Account' mod='blockwishlist'}</a></li>
		<li class="f_right"><a href="{$base_dir}"></a><a href="{$base_dir}" class="btn btn-default">{l s='Home' mod='blockwishlist'}</a></li>
	</ul>
</div>
