...
<div id="layered_block_left" class="block mega">
	<h3 class="title_block">
		<span>{l s='Find tour by' mod='blocklayered'}</span>
	</h3>
	...
	<div id="layered_ajax_loader" style="display: none;">
		<div class="filter_loader"><div class="img-loading"><img src="{$content_dir}themes/jms_travel/img/ajax-loader.gif" alt="" /></div></div>
	</div>
