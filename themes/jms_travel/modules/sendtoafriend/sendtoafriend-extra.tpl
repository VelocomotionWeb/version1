...
<div class="sendtofriend">
	<a id="send_friend_button" href="#send_friend_form" title="{l s='Send to a friend' mod='sendtoafriend'}"><i class="fa fa-envelope-o"></i><span>{l s='Send to a friend' mod='sendtoafriend'}</span></a>
</div>

<div style="display: none;">	
	<div id="send_friend_form" class="form-horizontal">
			<div class="panel panel-default">
			<h3 class="panel-heading">{l s='Send to a friend' mod='sendtoafriend'}</h3>
			<div class="panel-body clearfix">
				<div class="product form-group clearfix">
				...
				<div class="send_friend_form_content" id="send_friend_form_content">
					...
					<div class="form_container">						
						...
						<div class="text form-group">
							<label for="friend_name" class="col-sm-5 control-label">{l s='Name of your friend' mod='sendtoafriend'} <sup class="required">*</sup> :</label>
							<div class="col-sm-6">
								<input id="friend_name" name="friend_name" type="text" value="" class="form-control" />
							</div>	
						</div>
						<div class="text form-group">
							<label for="friend_email" class="col-sm-5 control-label">{l s='E-mail address of your friend' mod='sendtoafriend'} <sup class="required">*</sup> :</label>
							<div class="col-sm-6">
					...
					<div class="submit form-group">
						...
						<input id="sendEmail" class="btn btn-default" name="sendEmail" type="submit" value="{l s='Send' mod='sendtoafriend'}" />
						</div>
					</div>
				</div>
			</div>
