...
<div class="myaccount">
	...
	<div>
		<ul class="menu">
			...
			<li><a href="#" title="{l s='Advanced Search' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Recherche avancée' mod='blockmyaccountfooter'}</a></li>
			<li><a href="#" title="{l s='My Histories' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Historique de commandes' mod='blockmyaccountfooter'}</a></li>
			<li><a href="{$link->getPageLink('index', true, NULL, "mylogout")|escape:'html'}" title="{l s='Sign out' mod='blockmyaccount'}">{l s='Se Déconnecter' mod='blockmyaccount'}</a></li>
		</ul>		
	</div>
</div>
<!-- /Block myaccount module -->
