...
<div id="featured-products_block_center">
	<div class="slider-product-title">
		<h3 class="title">
			<span>{l s='Popular tours' mod='homefeatured'}</span>
			<span class="icon-title"></span>
		</h3>
		<p>{l s='Donec hendrerit integer sollicitudin felis quis maximus ultrices' mod='homefeatured'}</p>
	</div>
	<div class="row">
...
*}
						...
						<div class="product-info">
							...
							{if ($product.id_product_attribute == 0 OR (isset($add_prod_display) AND ($add_prod_display == 1))) AND $product.available_for_order AND !isset($restricted_country_mode) AND $product.minimal_quantity == 1 AND $product.customizable != 2 AND !$PS_CATALOG_MODE}
								...
								<a class="exclusive cart-button product-btn" data-id-product="{$product.id_product}" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='En savoir plus'}">
