...
{*
	<div class="block" id="compare_products">
		...
		<form method="post" action="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" class="compare-form">
			<button type="submit" class="bt_compare bt_compare{if isset($paginationId)}_{$paginationId}{/if}" disabled="disabled">
				<span>{l s='You have'} {count($compared_products)} {l s='destination to compare'}</span>
			</button>
