...
<div class="order_carrier_content box">
	...
	{else}
        ...
        *}
			...
			{/if}
            <div >
                {assign var='seller_info' value=Sellerinfodetail::getSellerInfoByProduct($product.id_product,'product')}
                <!-- <h1 class="page-heading step-num"> Location chez : {$seller_info.seller_name}{*l s='Delivery methods'*}</h1> -->
                <h1 class="page-heading step-num"> Location chez un partenaire Vélocomotion</h1>
                 <p id="seller_info">Les coordonnées détaillées du loueur vous seront communiquées dans l'email de réservation.</p>
            </div>
		...
		{if !$opc}
				<p class="cart_navigation clearfix">
					...
					{if isset($virtual_cart) && $virtual_cart || (isset($delivery_option_list) && !empty($delivery_option_list))}
						<button type="submit" name="processCarrier" class="btn btn-default">
							<span>
								{l s='Next'}
							</span>
						</button>
