...
<h1 class="page-heading">{l s='Top sellers'}</h1>
{if $products}
...
{else}
<div class="alert alert-warning"><button data-dismiss="alert" type="button" class="close">X</button>{l s='No top sellers for the moment.'}&nbsp;</div>
{/if}
