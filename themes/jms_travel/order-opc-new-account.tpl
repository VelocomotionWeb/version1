<div id="opc_new_account" class="opc-main-block">
	...
	<!-- <table class="table-bordered tableCustom">

		<tr>
			<th><h3 class="page-subheading">{l s='Already registered?'}</h3></th>
			<th><h3 id="new_account_title" class="page-subheading">{l s='New Customer'}</h3></th>
		</tr>
		<tr>
			<td>
				...
				<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
					<fieldset>
			        	<div class="box">
							...
							<div class="required clearfix gender-line content-hidde">
			                ...
			                *}
							...
							<div class="required text form-group content-hidde">
								<label for="firstname">{l s='First name'} <sup>*</sup></label>
							...
							<div class="text is_customer_param form-group content-hidde">
			                ...
			                *}
							...
							<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group content-hidde">
	...
	<p class="alert alert-success"><img src="{$modules_dir|escape:'html':'UTF-8'}mpstorelocator/views/img/store_logo/logo.png" style="width: 5%;"> &nbsp;&nbsp; <a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}">Cliquez ici</a> pour vous enregistrer ou vous identifier.</p>
