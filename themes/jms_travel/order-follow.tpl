...
{if isset($errorMsg) && $errorMsg}
	...
	<form method="POST"  id="returnOrderMessage">
		...
		<p>
	        <button type="submit" name="submitReturnMerchandise" class="btn btn-default">
	        	<span>
	        		{l s='Make an RMA slip'}<span class="fa fa-single-right right"></span>
	        	</span>
	        </button>
	   	</p>
	</form>
...
<ul class="footer_links clearfix">
	<li>
		<a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
			<span>
				<i class="fa fa-single-left"></i> {l s='Back to your account'}
			</span>
		</a>
	</li>
	<li>
		<a class="btn btn-default button button-small" href="{$base_dir}">
			<span>
				<i class="fa fa-single-left"></i> {l s='Home'}
			</span>
		</a>
	</li>
</ul>
