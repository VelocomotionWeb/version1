	...
	var Carousel = {
		...
		updateItems : function(){
			...
			if(base.options.singleItem === true){
				...
				base.options.itemsBigDesktop = false;
			...
			if(width > (base.options.itemsBigDesktop[0] || base.orignalItems) ){
			...
			if(typeof(base.options.itemsCustom) !== 'undefined' && base.options.itemsCustom !== false){
				...
				if(width <= base.options.itemsBigDesktop[0] && base.options.itemsBigDesktop !== false){
					base.options.items = base.options.itemsBigDesktop[1];
				}
