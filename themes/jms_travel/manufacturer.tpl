...
<h1 class="page-heading">{l s='List of products by manufacturer'}&nbsp;{$manufacturer->name|escape:'htmlall':'UTF-8'}</h1>
{if !empty($manufacturer->description) || !empty($manufacturer->short_description)}
<div class="description_box block">
...
{else}
<div class="alert alert-warning"><button data-dismiss="alert" type="button" class="close">X</button>{l s='No products for this manufacturer.'}</div>
{/if} 
{/if}
